[![GitHub tag (latest by date)](https://img.shields.io/github/v/tag/burakenez/gd32f5hc-cmake-vscode)](https://github.com/burakenez/gd32f5hc-cmake-vscode/tags/)

# GD32F5HC Demo Suites CMake Visual Studio Code Integration

🚀 Welcome to the **GD32F5HC Demo Suites CMake Visual Studio Code** repository! This project integrates the CMake build system with Visual Studio Code for **_[GD32F5HC Demo Suites V2.0.0](https://www.gd32mcu.com/en/download)_** and **_[GD32W51x F5HC Firmware Library V2.0.0](https://www.gd32mcu.com/en/download)_**, running entirely inside a container — **no local toolchain installation needed**.
...
```bash
git clone https://github.com/burakenez/gd32f5hc-cmake-vscode.git
```
...
- **Path:** `Drivers/CMSIS/GD/GD32F5HC`
- **Source:** `GD32F5HC Demo Suites V2.0.0`
...
│           │   ├── Core
│           │   │   ├── Inc
│           │   │   │   ├── gd32f5hc_it.h      # Interrupt handler declarations
│           │   │   │   ├── gd32f5hc_libopt.h  # Library options
│           │   │   │   └── systick.h                                  # SysTick timer declarations
│           │   │   └── Src
│           │   │       ├── gd32f5hc_it.c      # Interrupt service routines
│           │   │       ├── main.c                                     # Application entry point
│           │   │       ├── system_gd32f5hc.c  # Clock and core initialisation
│           │   │       └── systick.c                                  # SysTick timer implementation
│           │   ├── Startup
│           │   │   └── startup_gd32f5hc.s     # Reset handler and vector table
...
│           ├── Drivers
│           │   ├── BSP/GD32F5HCP_START              # Board support package for GD32F5HCP_START
│           │   ├── CMSIS                                 # CMSIS for Cortex-M / GD32F5HC
│           │   └── GD32F5HC_standard_peripheral  # Standard peripheral library
│           ├── .clang-format                # Code style rules
│           ├── CMakeLists.txt               # Top-level CMake build file
│           ├── CMakePresets.json            # Debug / Release preset definitions
│           ├── gd32f5hc_flash.ld  # Linker script (memory regions)
│           └── GD32F5HC.svd             # SVD file for peripheral register views
