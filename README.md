...
# GD32W51x F5HC Demo Suites CMake Visual Studio Code Integration

🚀 Welcome to the **GD32W51x F5HC Demo Suites CMake Visual Studio Code** repository! This project integrates the CMake build system with Visual Studio Code for **_[GD32W51x F5HC Demo Suites V2.0.0](https://www.gd32mcu.com/en/download)_** and **_[GD32W51x F5HC Firmware Library V2.0.0](https://www.gd32mcu.com/en/download)_**, running entirely inside a container — **no local toolchain installation needed**.
...
- **Source:** `GD32W51x F5HC Demo Suites V2.0.0`
